...
import com.mde.test.model.DDLExtractor;
...
public class DDLController {
	...
	private static DDLExtractor data = null;
	...
	public ModelAndView ddl(Locale locale,
		...
		System.out.println("Starting to process the request");
		data = new DDLExtractor(jndi);
		System.out.println("DDLExtractor created");
		ModelAndView model = new ModelAndView("ddl");
		String tables = data.getDDL(
